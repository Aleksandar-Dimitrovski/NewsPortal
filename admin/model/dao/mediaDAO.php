...
class MediaDAO extends Media
{
    ...
    public function insertMedia() {
        ...
        $this->db_conn->callStoreProcedure("_insert_media('$media_title', '$media_type', '$media_datetime', '$media_image_path', $category_id)");
    }
    ...
    public function updateMedia() {
        ...
        $columns_value = "'$media_title', '$media_type', '$media_datetime', '$media_image_path', $category_id, $media_id";
        $this->db_conn->callStoreProcedure("_update_media($columns_value)");
    }
